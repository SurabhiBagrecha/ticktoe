...
break;
case 1:
	intent = new Intent(context, CommonScreen.class);
	intent.putExtra("RESULT", "ZERO");
	context.startActivity(intent);
break;
case 2:
	intent = new Intent(context, CommonScreen.class);
	intent.putExtra("RESULT", "CROSS");
	context.startActivity(intent);
break;
case 3:
	intent = new Intent(context, CommonScreen.class);
...
mediaPlayer = MediaPlayer.create(this.context, R.raw.midi_sound);
caneta = new Paint();
...
if (whatdrawn)
{
cel = new Cross(singlesquare[x_aux][y_aux].x,singlesquare[x_aux][y_aux].y,context);
mediaPlayer.start();
whatdrawn = false;
mediaPlayer.stop();
}
...
{
cel = new Ball(singlesquare[x_aux][y_aux].x, singlesquare[x_aux][y_aux].y,context);
mediaPlayer.start();
whatdrawn = true;
mediaPlayer.stop();
}
